setwd("D:/school_grad school/Project_borealis_sex_determination/Analysis/sample_clustering_analysis/identify_by_borealisGonad_DEgene")
...
input_file <- "borealisGonadDEgene_tropTrna_blastnOut.tsv"
