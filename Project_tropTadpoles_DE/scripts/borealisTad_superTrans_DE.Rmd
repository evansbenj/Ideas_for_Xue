---
title: "borealisTad_superTrans_de"
author: "Xue Song"
date: "08/04/2019"
...
remove(mulMatch_allSca)
remove(SingleMatch)
remove(mulMatch_OneChr)
remove(mulMatch_sameChr)
```
...
## Combining DE information 
```{r combing DE and mapping info}
...
```{r Summarize DE result by categories}
...
```{r compute binomial confidence interval}
...
```{r plot with binomial CI, echo=False}
